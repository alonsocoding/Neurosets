...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.addDataset = function () {
        if (this.titledata == "" || this.descriptiondata == "") {
            __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()('Dataset incomplete', 'Your dataset is incomplete', 'error');
        }
        else {
            this.datasets.push({ name: this.titledata,
                description: this.descriptiondata });
            __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default()('Dataset saved', 'Your dataset is ready to work', 'success');
        }
    };
...
/***/ "./src/assets/icons/favicon-logo.png":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/assets/icons/favicon-logo.png";
